...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> update(@PathVariable Long idCliente, @RequestBody Cliente obj) {
		Cliente newObj = service.update(idCliente, obj);
		return ResponseEntity.ok().body(newObj);
	}

	@PatchMapping(value = "/{idCliente}")
	public ResponseEntity<Cliente> updatePatch(@PathVariable Long idCliente, @RequestBody Cliente obj) {
		Cliente newObj = service.update(idCliente, obj);
		return ResponseEntity.ok().body(newObj);
	}
