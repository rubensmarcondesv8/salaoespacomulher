...
public class ItemVenda implements Serializable{
	...
	public ItemVenda(Integer quantidadeItem, Produto itemProduto, Profissional profissionalVenda, Profissional salao) {
		...
		this.comissãoSalao = new Lancamento("Crédito comissão", this, comissao, salao.getContacorrente(), this.getItemProduto().getNomeProduto());
		this.pagamentoProfissional = new Lancamento("Pagamento serviço", this, pagamento, this.getProfissionalVenda().getContacorrente(), this.getItemProduto().getNomeProduto());
	}
	...
	public ItemVenda(Integer quantidadeItem, Servico itemServico, Profissional profissionalVenda, Profissional salao) {
		...
		this.comissãoSalao = new Lancamento("Comissão salão", this, comissao, salao.getContacorrente(), this.getItemServico().getNomeServico());
		this.pagamentoProfissional = new Lancamento("Pagamento serviço", this, pagamento, this.getProfissionalVenda().getContacorrente(), this.getItemServico().getNomeServico());
	}
